...
{
?>
Buscando por <strong title="Encontrado: <?php echo $total_produtos; ?> resultado<?php echo $total_produtos>1?'s':''; ?>."><?php echo $busca; ?></strong>
<?php
}
else
{
    echo 'Nenhum produto encontrado procurando por "'.$busca.'".';
}
?>
                </h3>
            </div>
...
{
?>
        <a href="<?php echo base_url('/buscar/'.(($pagina-1)>0?($pagina-1):1)); ?>" class="prev-btn"><i class="fa fa-angle-left"></i></a>
<?php
}
?>
        <div class="pages">
...
{
?>
            <a href="<?php echo base_url('/buscar/'.$i); ?>" <?php if ($pagina == $i){echo 'class="active"';} ?>><?php echo $i; ?></a>
<?php
}
?>
        </div> <!--end:pages-->
...
{
?>
        <a href="<?php echo base_url('/buscar/'.($pagina+1)); ?>" class="next-btn"><i class="fa fa-angle-right"></i> </a>
<?php
}
?>
    </div>
