<?php
/**
 * Classe de Recaptcha para formularios de e-mails
 */
class MY_Captcha
{
...
/*
    function exibir_form()
    {
        ...
        echo '<style>
                #recaptcha_widget{ position:relative;width:320px;height:125px;border:2px solid #999;-moz-border-radius:3px;border-radius:3px; background-image:url(/arquivos/captcha/fundo.png);}
   ...
   <div style="position:absolute;top:70px;left:220px;">
        <a href="javascript:Recaptcha.reload()"><img src="/arquivos/captcha/refresh.png"></a>
   </div>
   <div style="position:absolute;top:85px;left:220px;height:14px;" class="recaptcha_only_if_image">
        <a href="javascript:Recaptcha.switch_type(\'audio\')"><img src="/arquivos/captcha/audio.png"></a>
   </div>
   <div style="position:absolute;left:220px;top:99px;height:15px">
        <a href="javascript:Recaptcha.showhelp()"><img src="/arquivos/captcha/help.png"></a>
   </div>
