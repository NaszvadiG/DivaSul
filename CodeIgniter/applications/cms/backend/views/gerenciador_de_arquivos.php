...
$(function()
{
    $('#file_upload').uploadify(
    {
        ...
        onError         : function(event, ID, fileObj, errorObj)
        {
            ...
            alert('Desculpe o transtorno, mas não foi executar esta operação.');
        },
    ...
    <div id="divFora">
        <div id="padrao" style="display:block;min-width:920px;width:100%;border-top:1px solid #CCCCCC;padding-top:2px"><br>
            ...
            <table id="arquivos" style="text-align:center;border-top:1px solid #CCCCCC;" width="100%">
                <tr class="fundo">
                    <th width="130">A&ccedil;&atilde;o</th>
                    <th>Nome</th>
...
?>
                <tr onmouseover="over(this);" onmouseout="out(this);">
                    <td style="text-align:left;">
                        ...
                        <a id="<?php echo $dir; ?>" href="<?php echo site_url('gerenciador_de_arquivos/index/'.$current_dir.$dir); ?>" style="cursor:pointer;">
...
<?php
                    ...
                    {
?>
                        <a href="<?php echo site_url('gerenciador_de_arquivos/editar?file='.base64_encode($arquivos_path.$arquivo)); ?>"  style="cursor:pointer;">
